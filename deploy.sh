...
# --- CONFIGURATION ---
SERVER_USER="root"
SERVER_IP="167.172.94.64"
SERVER_DOMAIN="server5.gmstdevops.com"
PROJECT_NAME="pagasa-weather-demo.app"
FRONTEND_IMAGE_NAME="pagasa-weather-demoapp-frontend:latest"
BACKEND_IMAGE_NAME="pagasa-weather-demoapp-backend:latest"
